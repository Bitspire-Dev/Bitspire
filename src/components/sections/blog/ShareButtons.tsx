...
export default function ShareButtons({ title, buttons, tinaFields }: ShareButtonsProps) {
    ...
    return (
        <div className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-6 backdrop-blur-sm shadow-lg">
            <h3
                className="text-xs font-semibold tracking-wider uppercase text-slate-500 mb-4 pb-2 border-b border-slate-700/50"
            ...
            <div className="flex flex-col gap-2">
                ...
                >
                    ...
                    <span data-tina-field={tinaFields?.copy}>{labels.copy}</span>
                </button>
            </div>
        </div>
    );
