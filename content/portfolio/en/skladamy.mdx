...
slug: skladamy
description: 'A website with interactive configuration, API integrations, and an optimized build for Core Web Vitals.'
...
imageAlt: 'skladamy.com.pl website screenshot '
